...
import home.location.Countrysem;
...
public class AdministrativeArea {
    ...
    public static class Location {
        ...
        private home.location.AdministrativeArea administrativeArea;
        ...
        @JsonProperty("AdministrativeArea")
        public home.location.AdministrativeArea getAdministrativeArea() {
            return administrativeArea;
        }

        @JsonProperty("AdministrativeArea")
        public void setAdministrativeArea(home.location.AdministrativeArea administrativeArea) {
